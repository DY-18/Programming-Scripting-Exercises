...
In this exercise, an example of a pyhton program was provided by the lecturer, ![Dr Ian Mcloughlin](lecturer.jpg)from [Github](https://github.com/ianmcloughlin/python-fib/blob/master/fib.py).
